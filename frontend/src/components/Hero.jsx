    ...
    <section className="relative overflow-hidden pt-12 pb-20 md:pt-20 md:pb-28">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <motion.div
          ...
          className="inline-flex items-center space-x-2 px-4 py-1.5 rounded-full bg-indigo-500/10 border border-indigo-500/30 text-indigo-300 text-xs sm:text-sm font-medium mb-6 backdrop-blur-md"
        >
        ...
        >
          ...
          <Link
            to="/about"
            className="w-full sm:w-auto flex items-center justify-center space-x-2 px-6 py-4 rounded-2xl bg-slate-800/80 hover:bg-slate-700 text-slate-200 font-semibold text-base border border-slate-700/80 transition-all hover:scale-[1.02]"
          >
        ...
        >
          <div className="glass-panel p-6 rounded-2xl border border-slate-800/80 hover:border-indigo-500/30 transition-colors group">
            ...
            <h3 className="text-lg font-bold text-white mb-2">Interactive Matrix</h3>
            <p className="text-sm text-slate-400">Click any cell directly to toggle between 0, 1, and X don't-care states with real-time solver updates.</p>
          </div>

          <div className="glass-panel p-6 rounded-2xl border border-slate-800/80 hover:border-purple-500/30 transition-colors group">
            ...
            <h3 className="text-lg font-bold text-white mb-2">Wrap-Around Grouping</h3>
            <p className="text-sm text-slate-400">Detects torus edge adjacencies, 4-corner groups, and multi-subgrid 5-variable grouping seamlessly.</p>
          </div>

          <div className="glass-panel p-6 rounded-2xl border border-slate-800/80 hover:border-cyan-500/30 transition-colors group">
            ...
            <h3 className="text-lg font-bold text-white mb-2">Step-by-Step Logic</h3>
            <p className="text-sm text-slate-400">Walk through 5 structured educational steps detailing Gray code mapping, implicants, and EPIs.</p>
          </div>

          <div className="glass-panel p-6 rounded-2xl border border-slate-800/80 hover:border-emerald-500/30 transition-colors group">
            ...
            <h3 className="text-lg font-bold text-white mb-2">SymPy Verified</h3>
            <p className="text-sm text-slate-400">Every calculated Boolean term is mathematically cross-verified for absolute accuracy.</p>
          </div>
        </motion.div>
